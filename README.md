...
The notebook [5_fig2_itpc_eeg_lfp_layer_summary](https://github.com/chrihoni/University-of-Oslo_PCI_Mouse_Analysis/blob/main/5_fig2_itpc_eeg_lfp_layer_summary) plots itpc drop time of eeg and lfp data and performs hypothesis tests (phase-locking values saved to pandas dataframe returned by notebook 4). 
